 ...
 * @author Raghav
 */
public class PayWaterBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Water Bill Payment");

        companyCB.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        companyCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DELHI JAL BOARD" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayWaterBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
