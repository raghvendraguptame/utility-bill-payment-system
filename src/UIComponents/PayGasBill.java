 ...
 * @author Raghav
 */
public class PayGasBill extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Gas Bill Payment");

        companyCB.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        companyCB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Indraprastha Gas Limited", "Embrace Gas Pipelines Pvt. Ltd", "Adani Gas" }));
    ...
    private void fetchBTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_fetchBTActionPerformed
       ...
       PaymentPortal obj = new PaymentPortal();
        ...
        System.out.println(e.getBillId());
        ...
        {    JOptionPane.showMessageDialog(this,"BILL FETCHED SUCCESSFULLY");
            ...
            ecusID.setText(e.getCustomerId());
            edate.setText(e.getDate());
            eunits.setText(e.getUnits());
            estatus.setText(e.getStatus());
            etype.setText(e.getType());
            obj.setValuesForGas(e); 
        }
        else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PayGasBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
