...
public class GasBill
{
    ...
    public GasBill(String billId,String customerId,String units)
    {
        this.billId=billId;
        this.type="GasBill";
    ...
    public GasBill searchFromDB(String billid)
    {
        ...
        {	
			Connection connect = conFac.getConnection();
				...
				PreparedStatement stmt=connect.prepareStatement("select * from gasbill where billid = ?");
